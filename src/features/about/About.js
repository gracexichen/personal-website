function About() {
	return (
		<div id="about" className="flex flex-row bg-turquoise h-[45rem]">
			...
			<div className="flex flex-col w-1/2 h-full space-y-10 align-middle justify-center">
                <div class="space-y-3">
					<h3 className="text-6xl font-satisfy">About Me</h3>
					<p className="text-2xl">Let me introduce myself!</p>
				</div>
				...
				<p className="pl-5 text-2xl">Hi, I'm Grace! I am currently a sophomore studying computer science at UC Davis. I love watching anime, watching kdramas, listening to music, crocheting, and coding. In my future, I want to be a software developer where I can code a lot of cool websites and applications.</p>
			</div>
		</div>
	);
}
